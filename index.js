...
// function tap(x){
//     let finded = arr.find(item => item.id == x)
//     console.log(finded.shipAddress.country)
// }
...
// function tap(x){
//     let finded = arr.filter(item => item.shipAddress.country == x)
//     console.log(finded)
// }
...
// function tap(x){
//     let finded = arr.find(item => item.id == x)
//     console.log(finded.shipName,finded.shipAddress.country,finded.shipAddress.city)
// }
...
// function tap(x){
//     let finded = arr.find(item => item.id == x)
//     console.log(finded.details.length)
// }
...
// const tap = x => {
//     const object = arr.find(item => item.id === x);
//     let sum = 0

//     object.details.forEach(item => {
...
//         const tap = x => {
//             const object = data.find(item => item.id === x);
//             let sum = 0
